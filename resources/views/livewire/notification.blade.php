<div
    ...
    x-init="$nextTick(() => {
        window.addEventListener('dismissNotification', () => {
        ...
        <div class="p-4">
            <div class="flex items-start">
                ...
                <div class="ml-4 flex-shrink-0 flex">
                    <button wire:click="dismiss" class="inline-flex text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
